...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.sqlite.url' => 'string',
            ...
            'database.connections.mysql.url' => 'string',
            ...
            'database.connections.mariadb.url' => 'string',
            ...
            'database.connections.pgsql.url' => 'string',
            ...
            'database.connections.sqlsrv.url' => 'string',
            ...
            'filesystems.links./home/ddr-3/Proyectos/cashtrackr/public/storage' => 'string',
...
'cors.exposed_headers','cors.max_age','cors.supports_credentials','concurrency.default','broadcasting.default',
...
'broadcasting.connections.ably.driver','broadcasting.connections.ably.key','broadcasting.connections.log.driver','broadcasting.connections.null.driver','hashing.driver',
...
'filesystems.links./home/ddr-3/Proyectos/cashtrackr/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'signed','throttle','verified',);
        registerArgumentsSet('routes', 'register','register.store','login',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'auth.login','auth.register','layouts.auth','layouts.base','welcome',
...
'DB_URL','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT','SESSION_PATH',
