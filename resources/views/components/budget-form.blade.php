...
<div class="flex flex-col gap-2">
    <div class="flex gap-2 items-center">
        ...
        <div class="relative inline-block group">
            ...
            <div
                ...
                <p><span class="font-bold">Presupuesto General</span> te permite almacenar gastos con categorías, ideal
                    para presupuestos semanales o mensuales.</p>
                <p><span class="font-bold">Proyecto</span> te permite almacenar gastos relacionados como una graduación,
    ...
    >
        ...
        <option
            value="general"
            {{ old('type', $budget->type->value ?? '') === 'general' ? 'selected' : '' }}
        >General - Con Categorías</option>
        <option value="goal"
            {{ old('type', $budget->type->value ?? '') === 'goal' ? 'selected' : '' }}
        >Proyecto</option>
    </select>
